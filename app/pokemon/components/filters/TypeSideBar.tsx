...
import { typeCode, typesColor } from "@/app/utils/config";
            ...
            return (
              <div
                className={`
                  ...
                  style={{ backgroundColor: currentType === type.name.toLowerCase() ? typesColor[type.name.toLowerCase()] : typesColor[type.name.toLowerCase()]+50 }}
